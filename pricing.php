...
<section class="pricing">
   ...
   <div class="box-container">
      ...
      <div class="box">
         <h3>basic plan</h3>
         <div class="price">Rs.2,50,000/-</div>
         <div class="list">
      ...
      <div class="box">
         <h3>premium plan</h3>
         <div class="price">Rs.6,50,000/-</div>
         <div class="list">
            <p> <i class="fas fa-check"></i> photography</p>
            <p> <i class="fas fa-check"></i> bribe makeup</p>
            <p> <i class="fas fa-check"></i> wedding ceromony</p>
      ...
      <div class="box">
         <h3>ultimate plan</h3>
         <div class="price">Rs.12,50,000/-</div>
         <div class="list">
            <p> <i class="fas fa-check"></i> photography</p>
            <p> <i class="fas fa-check"></i> bribe makeup</p>
            <p> <i class="fas fa-check"></i> wedding ceromony</p>
   ...
   <div class="swiper reviews-slider">
      ...
      <div class="swiper-wrapper">
         ...
         <div class="swiper-slide slide">
            <img src="images/Aswin's Image.jpg" alt="">
            <h3>Aswin Viswajith N R</h3>
         ...
         <div class="swiper-slide slide">
            <img src="images/Aswin's Image.jpg" alt="">
            <h3>Aswin Viswajith N R</h3>
            <p>Lorem ipsum dolor sit amet consectetur adipisicAswin Viswajith N Rg elit. Fuga magni perspiciatis aut repellat nihil? Eveniet fugit eius quos architecto repellendus.</p>
            <div class="stars">
               <i class="fas fa-star"></i>
               <i class="fas fa-star"></i>
               <i class="fas fa-star"></i>
